			...
			meta: [
				{
					name: 'description',
					content:
						'EU・日本の作家たちによる手描きアニメーションが、河内音頭に合わせて踊り続けるアニメーションの盆踊り。 / A hand-drawn animated bon-odori by EU and Japanese animation artists, dancing endlessly to Kawachi Ondo.',
				},
