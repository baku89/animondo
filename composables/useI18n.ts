const messages = {
	en: {
		'meta.description':
			'A bon-odori of hand-drawn characters by EU and Japanese artists, dancing endlessly to the rhythm of Kawachi Ondo. Born from the Osaka Expo 2025 EU–Japan Animation Residency.',
	...
	ja: {
		'meta.description':
			'EU・日本の作家たちが手描きしたキャラクターが、河内音頭のリズムに合わせて踊り続けるアニメーションの盆踊り。大阪・関西万博2025 EU–日本アニメーションレジデンシーから生まれました。',
		'tap.title': 'タップで開始',
